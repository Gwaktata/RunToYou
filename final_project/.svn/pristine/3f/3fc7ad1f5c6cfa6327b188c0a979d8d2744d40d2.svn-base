...
<script>
	...
	const fnSelectListAllCam = (treatCd) => {
		fnCommonAjax('post', { 'treatCd': treatCd}, '/medical/selectListCam', fnSelectListCamSuccess1);
// 		fnCommonAjax('post', { 'treatCd': treatCd, 'fileCls': '검사사진' }, '/medical/selectListCam', fnSelectListCamSuccess2);
	}
